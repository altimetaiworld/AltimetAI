...
def index():
    ...
    seo = get_seo_metadata(
        title="AI Transformation & Automation Consulting",
        description="Altimet AI identifies operational bottlenecks and designs, builds, and deploys production-grade AI systems."
    )
...
def services():
    ...
    seo = get_seo_metadata(
        title="AI Solutions & Consulting Capabilities",
        description="Explore Altimet AI's core capabilities: AI Knowledge & Support Agents, AI Voice Agents, WhatsApp AI, and Workflow Automation."
    )
...
def service_detail(slug):
    ...
    seo = get_seo_metadata(
        title=f"{service['name']} - Solutions",
...
def industries():
    ...
    seo = get_seo_metadata(
        ...
        description="Delivering measurable operational impact across Retail, Ecommerce, Real Estate, Manufacturing, Finance, and Logistics."
    )
...
def case_studies():
    ...
    seo = get_seo_metadata(
        title="AI in Production · Example AI Workflows",
        description="Real-world examples demonstrating how production AI workflows eliminate operational bottlenecks and automate high-friction tasks."
    )
...
def case_study_detail(slug):
    ...
    seo = get_seo_metadata(
        title=f"{cs['title']} - Example AI Workflow",
...
def about():
    seo = get_seo_metadata(
        title="About Altimet AI · AI Transformation Consulting",
        description="Learn about Altimet AI's business-first approach to AI transformation, engineering rigor, and deployment standards."
    )
...
def contact():
    ...
    if request.method == 'POST':
        ...
        if form.validate():
            ...
            smtp_from = os.environ.get('SMTP_FROM', 'hello@altimetai.com')
...
def book_consultation():
    ...
    seo = get_seo_metadata(
        ...
        description="Schedule a 30-minute consultation to identify high-impact AI opportunities in your operations."
    )
