...
class ContentService:
    ...
    def get_services():
        return [
            {
                "id": "ai-knowledge-support-agent",
                "slug": "ai-knowledge-support-agent",
                "name": "AI Knowledge & Support Agents",
                "tagline": "Unified Internal Knowledge & Instant Customer Support",
                "icon": "book-open",
                "short_description": "Turn disparate documentation, FAQs, contracts, and SOPs into an accurate, 24/7 conversational support agent for your customers and internal teams.",
                "overview": (
                    "Disorganized company documentation creates massive support bottlenecks and frustrates both customers and employees. "
                    "Altimet AI builds custom Knowledge & Support Agents grounded directly in your company's authoritative data sources. "
                    "By combining multi-stage document ingestion, semantic search, and strict citation guardrails, our agents answer "
                    "complex questions accurately with zero hallucinations and seamless human escalation when required."
                ),
                "business_problems": [
                    "Support teams drowning in repetitive tier-1 customer inquiries, driving up response times.",
                    "Internal staff losing hours searching through wikis, PDFs, and disjointed systems for critical information.",
                    "Inconsistent customer answers leading to customer churn and compliance exposure."
                ],
                "solution": (
                    "We design and deploy production-grade RAG and agent architectures that connect directly to your existing systems "
                    "(Notion, Google Drive, Zendesk, internal databases). Our systems include citation-backed responses, confidence scoring, "
                    "automated feedback loops, and intelligent handoffs to human agents."
                ),
                "benefits": [
                    {"label": "Support Ticket Resolution", "value": "65% Autonomous"},
                    {"label": "First Response Time", "value": "<10 Seconds"},
                    {"label": "Citation Accuracy", "value": "99.2%"}
                ],
                "architecture_steps": [
                    {"title": "Multi-Source Ingestion", "desc": "Ingests docs, PDFs, CRM logs, and wikis with automated real-time synchronization."},
                    {"title": "Semantic Chunking & Embedding", "desc": "Retains contextual hierarchy and generates domain-specific vector representations."},
                    {"title": "Guardrails & Verification", "desc": "Evaluates factual accuracy, filters hallucinations, and attaches exact source links."},
                    {"title": "Omnichannel Deployment", "desc": "Integrates directly into web chat, Zendesk, Freshdesk, Slack, or Microsoft Teams."}
                ],
                "timeline": [
                    {"phase": "Phase 1: Knowledge Audit", "duration": "Week 1", "details": "Assess data sources, documentation quality, and common inquiry taxonomy."},
                    {"phase": "Phase 2: RAG Pipeline Build", "desc": "Configuring vector indexing, reranking models, and prompt guardrails.", "duration": "Weeks 2-3"},
                    {"phase": "Phase 3: Helpdesk Integration", "desc": "Connecting with CRM, helpdesk software, and setting up human escalation workflows.", "duration": "Weeks 4-5"},
                    {"phase": "Phase 4: Pilot & Optimization", "desc": "Evaluating live accuracy, tuning answer quality, and team onboarding.", "duration": "Week 6"}
                ],
                "faq": [
                    {
                        "q": "How do you guarantee the AI will not hallucinate incorrect information?",
                        "a": "Our architecture forces strict retrieval constraints. If the agent cannot locate verifiable evidence in your approved documentation with high confidence, it gracefully declines to guess and routes the query to a human agent."
                    },
                    {
                        "q": "Can the agent integrate with our existing ticketing system?",
                        "a": "Yes. We integrate natively with Zendesk, Freshdesk, Salesforce Service Cloud, Intercom, and custom webhook APIs."
                    }
                ]
            },
            {
                ...
                "tagline": "Conversational Inbound & Outbound Phone Automation",
                "icon": "phone-call",
                "short_description": "Deploy human-grade conversational voice agents for front-desk reception, appointment booking, lead qualification, and 24/7 call triage.",
                "overview": (
                    "Missed calls represent lost revenue and frustrated customers. Altimet AI builds sub-second latency AI Voice Agents "
                    "that converse naturally over standard phone lines. Capable of handling complex multi-turn conversations, understanding interruptions, "
                    "extracting caller intent, and triggering backend actions like scheduling calendars or updating CRMs, our voice agents ensure "
                    "no customer call goes unanswered."
                ),
                "business_problems": [
                    "High volume of missed calls during peak hours or outside business operating times.",
                    "Front desk and sales staff spending hours on repetitive screening and appointment scheduling.",
                    "Long call wait times driving customer dissatisfaction and high abandonment rates."
                ],
                "solution": (
                    "We architect ultra-low-latency voice pipelines combining speech-to-text, low-latency reasoning engines, and "
                    "expressive neural speech synthesis. Agents integrate directly with your telephony (Twilio, SIP trunking), "
                    "scheduling systems (Cal.com, Calendly), and core CRMs."
                ),
                "benefits": [
                    {"label": "Call Answering Rate", "value": "100%"},
                    {"label": "Average Latency", "value": "<600ms"},
                    {"label": "Booking Conversion Lift", "value": "+35%"}
                ],
                "architecture_steps": [
                    {"title": "Telephony Gateway", "desc": "Connects via WebRTC, SIP trunk, or Twilio to route calls dynamically."},
                    {"title": "Streaming Speech-to-Text", "desc": "High-accuracy streaming transcription with custom vocabulary for your industry."},
                    {"title": "Dynamic Dialog Engine", "desc": "Manages conversation state, handles barge-in interruptions, and validates inputs."},
                    {"title": "Neural Voice Synthesis", "desc": "Ultra-realistic, natural voice generation with brand-tailored accents and tone."}
                ],
                "timeline": [
                    {"phase": "Phase 1: Call Flow Discovery", "duration": "Week 1", "details": "Analyze typical call scripts, edge cases, and required integration endpoints."},
                    {"phase": "Phase 2: Voice Pipeline Setup", "desc": "Configuring telephony triggers, latency optimization, and voice persona tuning.", "duration": "Weeks 2-3"},
                    {"phase": "Phase 3: CRM & Booking Wiring", "desc": "Connecting calendar APIs, CRM contact lookups, and transfer protocols.", "duration": "Weeks 4-5"},
                    {"phase": "Phase 4: Field Testing & Launch", "desc": "Simulated call stress testing, live shadow dialing, and staff transfer training.", "duration": "Week 6"}
                ],
                "faq": [
                    {
                        "q": "How does the AI handle accents and background noise?",
                        "a": "Our streaming acoustic models are trained on diverse multi-accent real-world audio datasets with built-in noise suppression and phrase normalization."
                    },
                    {
                        "q": "Can the voice agent transfer a call to a live human?",
                        "a": "Yes. If the caller requests an operator or if the conversation requires human expertise, the agent executes an instant warm or cold transfer with caller context passed to your team."
                    }
                ]
            },
            {
                "id": "whatsapp-ai-engagement",
                "slug": "whatsapp-ai-engagement",
                "name": "WhatsApp AI & Customer Engagement",
                "tagline": "Conversational Commerce, Lead Qualification & 24/7 Support",
                "icon": "message-circle",
                "short_description": "Transform WhatsApp into an autonomous sales, qualification, and customer service engine connected directly to your business workflows.",
                "overview": (
                    "WhatsApp is the world's most accessible communication channel, yet most businesses struggle with slow manual replies. "
                    "Altimet AI builds intelligent WhatsApp conversational agents that qualify inbound prospects, answer catalog questions, "
                    "process order statuses, and re-engage dormant leads — all powered by official WhatsApp Business APIs and enterprise guardrails."
                ),
                "business_problems": [
                    "Prospects inquiring on WhatsApp going cold because staff cannot reply in minutes.",
                    "Sales reps spending hours answering the same preliminary pricing and qualification questions.",
                    "Lack of structured CRM sync for WhatsApp leads, leading to lost customer records."
                ],
                "solution": (
                    "We build end-to-end WhatsApp automation flows using the official Meta Cloud API. Our solutions combine natural "
                    "conversational intelligence with structured buttons, catalog browsing, interactive lists, and real-time CRM two-way synchronization."
                ),
                "benefits": [
                ...
                "architecture_steps": [
                    {"title": "Meta Cloud API Gateway", "desc": "Secure, verified business messaging infrastructure with high throughput."},
                    {"title": "Conversational Router", "desc": "Parses intent, classifies lead priority, and maintains cross-session memory."},
                    {"title": "Interactive Message UI", "desc": "Employs WhatsApp action buttons, lists, and media attachments for easy engagement."},
                    {"title": "CRM & ERP Webhooks", "desc": "Instantly syncs chat logs, contact attributes, and deal stages with your CRM."}
                ],
                "timeline": [
                    {"phase": "Phase 1: Flow Architecture", "duration": "Week 1", "details": "Map user journeys, qualification criteria, and Meta WhatsApp Business API setup."},
                    {"phase": "Phase 2: Agent Logic Build", "desc": "Programming conversational states, dynamic responses, and product catalog sync.", "duration": "Weeks 2-3"},
                    {"phase": "Phase 3: Webhook & CRM Sync", "desc": "Connecting HubSpot, Salesforce, Zoho, or internal databases via webhooks.", "duration": "Weeks 4-5"},
                    {"phase": "Phase 4: Compliance & Go-Live", "desc": "Meta template approvals, end-to-end verification, and team training.", "duration": "Week 6"}
                ],
                "faq": [
                    {
                        "q": "Do you use the official WhatsApp Business API?",
                        "a": "Yes. We strictly build on the official Meta Cloud API and WhatsApp Business Solution Providers, ensuring complete compliance, verified green tick eligibility, and no risk of account bans."
                    },
                    {
                        "q": "Can human agents take over the conversation on WhatsApp?",
                        "a": "Absolutely. Our architecture supports unified shared inboxes where human agents can step in at any time, pausing the AI agent automatically."
                    }
                ]
            },
            {
    ...
    def get_industries():
        return [
            ...
            },
            {
                ...
                "name": "Real Estate",
                "icon": "home",
                "headline": "24/7 Lead Qualification, Automated Viewing Bookings & Tenant Support",
                "intro": "Qualify prospective buyers and tenants instantly, coordinate property viewings autonomously, and resolve tenant inquiries around the clock.",
                "challenges": [
                    "High-value property leads going cold when inquiries arrive outside business hours.",
                    "Agents overwhelmed with repetitive questions about pricing, floor plans, and amenities.",
                    "Manual coordination delays in scheduling viewings and managing tenant maintenance requests."
                ],
                "solutions": [
                    "Omnichannel WhatsApp and Voice agents that qualify buyer budgets and intent within seconds.",
                    "Automated calendar booking integrated directly with agent availability and CRM systems.",
                    "Intelligent maintenance request routing that triages urgency and updates property managers."
                ],
                "impact": "3.5x faster lead response time, 45% increase in booked viewing conversions."
            }
        ]
        ...
        return [
            {
                ...
                "client": "Multinational Omnichannel Retailer",
                ...
                "challenge": (
                    "The client operated multiple SQL databases across regional warehouses. "
            ...
            },
            {
                ...
                "client": "Automotive Equipment Manufacturer",
                ...
                "challenge": (
                    "Factory floor mechanics lost valuable time searching through "
            ...
            },
            {
                ...
                "client": "Private Investment & Asset Firm",
            ...
            },
            {
                ...
                "client": "Regional Freight & Logistics Operator",
        ...
        return [
            {
                ...
                "date": "June 15, 2026",
                "author": "Altimet AI Engineering Team",
            ...
            },
            {
                ...
                "date": "May 28, 2026",
                "author": "Altimet AI Applied AI Group",
            ...
            },
            {
                ...
                "date": "April 12, 2026",
                "author": "Altimet AI Solutions Team",
